        ...
        <div className="hero">
            ...
            <div className='page3 grid grid-cols-4 gap-4 grid-rows-6 pb-5'>
                ...
                <div className='content col-start-2 row-start-3 row-end-5 ml-0'>
                    <div className='flex flex-row justify-center '>
                        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/6a/JavaScript-logo.png/800px-JavaScript-logo.png" alt="JS.logo" style={{borderRadius:'20px', }} />
                    </div>
                </div>
                <div className='content col-start-3 row-start-3 row-end-5 ml-0'>
                    <div className='flex flex-row justify-center align-center'>
                        <img src="https://i0.wp.com/www.ruhidesain.com/wp-content/uploads/2017/10/nodejs-logo-e1497443346889.png?fit=435%2C473&ssl=1" alt="nodeJS.logo" style={{borderRadius:'20px', }} />
                    </div>
                </div>
                <div className='content col-start-4 row-start-3 row-end-5 mr-5'>
                    <div className='flex flex-row justify-center'>
                        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/d5/Tailwind_CSS_Logo.svg/320px-Tailwind_CSS_Logo.svg.png" alt="tailwind.logo" />
                    </div>
                </div>
                <div className='content col-start-1 row-start-5 row-end-7 ml-5'>
                    <div className='flex flex-row justify-center'>
                        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/18/ISO_C%2B%2B_Logo.svg/1822px-ISO_C%2B%2B_Logo.svg.png" alt="cpp.logo" style={{borderRadius:'20px', }} />
                    </div>
                </div>
                <div className='content col-start-2 row-start-5 row-end-7 ml-0'>
                    <div className='flex flex-row justify-center'>
                        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/05/Go_Logo_Blue.svg/1200px-Go_Logo_Blue.svg.png" alt="golang.logo" style={{borderRadius:'20px', }} />
                    </div>
                </div>
                <div className='content col-start-3 row-start-5 row-end-7 ml-0'>
                    <div className='flex flex-row justify-center'>
                        <img src="https://cdn-icons-png.flaticon.com/256/174/174854.png" alt="html.logo" />
                    </div>
                </div>
                <div className='content col-start-4 row-start-5 row-end-7 mr-5'>
                    <div className='flex flex-row justify-center'>
                        <img src="https://cdn4.iconfinder.com/data/icons/social-media-logos-6/512/121-css3-512.png" alt="css.logo" />
                    </div>
                </div>
            </div>
            {/* Page 3 End */}
